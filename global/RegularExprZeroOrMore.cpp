...
namespace PortfolioExplorer {
	...
	///////////////////////////////////////////////////////////////////////////////
	bool RegularExprZeroOrMore::GenerateNFA(RegularExprEngineBase* engine, NFANode* startNode, NFANode* endNode)
	{
		assert(bound);
		...
		// Attach NULL arc from start to center
		NFAArcRef arc = new NFAArc(0);
		startNode->AttachOutgoingArc(arc);
		arc->AttachToNode(centerNode);
	...
	///////////////////////////////////////////////////////////////////////////////
	bool RegularExprZeroOrMore::SetupBind(OrdinalMap& map, ListenerRef listener)
	{
	...
	///////////////////////////////////////////////////////////////////////////////
	bool RegularExprZeroOrMore::Bind(OrdinalMap& map, ListenerRef listener)
	{
	...
	// Return value:
	///////////////////////////////////////////////////////////////////////////////
	void RegularExprZeroOrMore::Dump(std::ostream& os, TsString prefix)
	{
		os << prefix.c_str() << "*" << '\n';
