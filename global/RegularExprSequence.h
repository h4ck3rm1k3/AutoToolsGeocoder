...
// RegularExprSequence.h: Implementation of sequences in regular expressions

#ifndef INCL_REGULAREXPRSEQUENCE_H
#define INCL_REGULAREXPRSEQUENCE_H
...
namespace PortfolioExplorer {
	class RegularExprSequence : public RegularExpr {
	...
	public:
		...
		// Constructor
		///////////////////////////////////////////////////////////////////////////////
		RegularExprSequence(std::vector<RegularExprRef> expressions_) : expressions(expressions_) {};

		///////////////////////////////////////////////////////////////////////////////
		// Destructor
		///////////////////////////////////////////////////////////////////////////////
		virtual ~RegularExprSequence() {};
