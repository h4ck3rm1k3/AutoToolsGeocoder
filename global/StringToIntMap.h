...
// JH_StringToIntMap.h: An object that wraps std::map<TsString, int> in a
...
#ifndef JH_StringToIntMap_H
#define JH_StringToIntMap_H
...
namespace PortfolioExplorer {
	...
	class StringToIntMap : public std::map<TsString, int>, public VRefCount 
	{
	};
	typedef refcnt_ptr<StringToIntMap> StringToIntMapRef;
}
