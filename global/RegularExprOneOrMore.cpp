...
// RegularExprOneOrMore.cpp: Defines the regular expression + object
...
namespace PortfolioExplorer {
	...
	///////////////////////////////////////////////////////////////////////////////
	bool RegularExprOneOrMore::GenerateNFA(RegularExprEngineBase* engine, NFANode* startNode, NFANode* endNode)
	{
		assert(bound);

		// Create a new node where the loop will attach
		NFANode* centerNode = engine->CreateNFANode();

		// Generate NFA from start to center
		if( !expression->GenerateNFA(engine, startNode, centerNode) ) {
			return false;
		}
		
		// Generate NFA for expression loop
		if( !expression->GenerateNFA(engine, centerNode, centerNode) ) {
			return false;
		}
		
		// Attach NULL arc from center to end
		NFAArcRef arc = new NFAArc(0);
		centerNode->AttachOutgoingArc(arc);
	...
	///////////////////////////////////////////////////////////////////////////////
	bool RegularExprOneOrMore::SetupBind(OrdinalMap& map, ListenerRef listener)
	{
	...
	///////////////////////////////////////////////////////////////////////////////
	bool RegularExprOneOrMore::Bind(OrdinalMap& map, ListenerRef listener)
	{
	...
	// Return value:
	///////////////////////////////////////////////////////////////////////////////
	void RegularExprOneOrMore::Dump(std::ostream& os, TsString prefix)
	{
		os << prefix.c_str() << "+" << '\n';
