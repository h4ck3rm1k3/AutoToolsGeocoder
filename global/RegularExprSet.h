...
// RegularExprSet.h: Implementation of sets in regular expressions

#ifndef INCL_REGULAREXPRSET_H
#define INCL_REGULAREXPRSET_H
...
namespace PortfolioExplorer {
	class RegularExprSet : public RegularExpr {
	...
	public:
		...
		// Constructor
		///////////////////////////////////////////////////////////////////////////////
		RegularExprSet(bool negate_, std::vector<RegularExprLiteralRef> arguments_) : 
		  negate(negate_), arguments(arguments_) {};

		///////////////////////////////////////////////////////////////////////////////
		// Destructor
		///////////////////////////////////////////////////////////////////////////////
		virtual ~RegularExprSet() {};
