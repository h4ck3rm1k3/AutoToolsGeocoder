...
// RegularExprLiteral.h: Implementation of literals in regular expressions

#ifndef INCL_REGULAREXPRLITERAL_H
#define INCL_REGULAREXPRLITERAL_H
...
namespace PortfolioExplorer {
	class RegularExprLiteral : public RegularExpr {
	
	friend class RegularExprSet;
	...
	public:
		...
		// Constructor
		///////////////////////////////////////////////////////////////////////////////
		RegularExprLiteral(RegularExprToken token_) : token(token_) {};

		///////////////////////////////////////////////////////////////////////////////
		// Destructor
		///////////////////////////////////////////////////////////////////////////////
		virtual ~RegularExprLiteral() {};
		...
		///////////////////////////////////////////////////////////////////////////////
		virtual bool SimpleSequence() { return true; }

	protected:
		RegularExprToken token;         
		BitsetRef ordinals;
	};
	typedef refcnt_ptr<RegularExprLiteral> RegularExprLiteralRef;
} //namespace indexer
