...
// CoordinateBrowseGrid.h: A "virtual" grid that supports direct browsing of
// the Coordinate records of the geocoder database.

#ifndef INCL_CoordinateBrowseGrid_H
#define INCL_CoordinateBrowseGrid_H

/////////////////////////////////////////////////////////////////////////////
// CCoordinateBrowseGrid window.  Grid subclass that uses a FileFollower to browse
// the contents of a file that is being written.
/////////////////////////////////////////////////////////////////////////////

class CCoordinateBrowseGrid : public CGXGridWnd
{
public:
	/////////////////////////////////////////////////////////////////////////////
	// constructor
	/////////////////////////////////////////////////////////////////////////////
	CCoordinateBrowseGrid();

	/////////////////////////////////////////////////////////////////////////////
	// destructor
	/////////////////////////////////////////////////////////////////////////////
	virtual ~CCoordinateBrowseGrid();
	...
	//{{AFX_VIRTUAL(CCoordinateBrowseGrid)
	//}}AFX_VIRTUAL

protected:
	// Generated message map functions
	//{{AFX_MSG(CCoordinateBrowseGrid)
	//}}AFX_MSG
	DECLARE_MESSAGE_MAP()
...
private:
	...
	// Start and end of row selection.
	int selStart, selEnd;
};
