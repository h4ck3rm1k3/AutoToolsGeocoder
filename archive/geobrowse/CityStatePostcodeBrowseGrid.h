...
// CityStatePostcodeBrowseGrid.h: A "virtual" grid that supports direct browsing of
// the CityStatePostcode records of the geocoder database.

#ifndef INCL_CityStatePostcodeBrowseGrid_H
#define INCL_CityStatePostcodeBrowseGrid_H

/////////////////////////////////////////////////////////////////////////////
// CCityStatePostcodeBrowseGrid window.  Grid subclass that uses a FileFollower to browse
// the contents of a file that is being written.
/////////////////////////////////////////////////////////////////////////////

class CCityStatePostcodeBrowseGrid : public CGXGridWnd
{
public:
	/////////////////////////////////////////////////////////////////////////////
	// constructor
	/////////////////////////////////////////////////////////////////////////////
	CCityStatePostcodeBrowseGrid();

	/////////////////////////////////////////////////////////////////////////////
	// destructor
	/////////////////////////////////////////////////////////////////////////////
	virtual ~CCityStatePostcodeBrowseGrid();
	...
	//{{AFX_VIRTUAL(CCityStatePostcodeBrowseGrid)
	//}}AFX_VIRTUAL

	///////////////////////////////////////////////////////////////////////////
	// Set the highlighted selection
	///////////////////////////////////////////////////////////////////////////
	void SetRowSelection(int selStart, int selEnd);

protected:
	// Generated message map functions
	//{{AFX_MSG(CCityStatePostcodeBrowseGrid)
	//}}AFX_MSG
	DECLARE_MESSAGE_MAP()
