...
// StreetIntersectionSoundexBrowseGrid.h: A "virtual" grid that supports direct browsing of
// the StreetIntersectionSoundex records of the geocoder database.

#ifndef INCL_StreetIntersectionSoundexBrowseGrid_H
#define INCL_StreetIntersectionSoundexBrowseGrid_H

/////////////////////////////////////////////////////////////////////////////
// CStreetIntersectionSoundexBrowseGrid window.  Grid subclass that uses a FileFollower to browse
// the contents of a file that is being written.
/////////////////////////////////////////////////////////////////////////////

class CStreetIntersectionSoundexBrowseGrid : public CGXGridWnd
{
public:
	/////////////////////////////////////////////////////////////////////////////
	// constructor
	/////////////////////////////////////////////////////////////////////////////
	CStreetIntersectionSoundexBrowseGrid();

	/////////////////////////////////////////////////////////////////////////////
	// destructor
	/////////////////////////////////////////////////////////////////////////////
	virtual ~CStreetIntersectionSoundexBrowseGrid();
	...
	//{{AFX_VIRTUAL(CStreetIntersectionSoundexBrowseGrid)
	//}}AFX_VIRTUAL

protected:
	// Generated message map functions
	//{{AFX_MSG(CStreetIntersectionSoundexBrowseGrid)
	//}}AFX_MSG
	DECLARE_MESSAGE_MAP()
...
private:
	...
	enum {
		...
		NameID2Column,
		RangeOffset2Column,
		ColumnCount = RangeOffset2Column
	};
