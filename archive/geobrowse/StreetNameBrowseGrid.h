...
// StreetNameBrowseGrid.h: A "virtual" grid that supports direct browsing of
// the StreetName records of the geocoder database.

#ifndef INCL_StreetNameBrowseGrid_H
#define INCL_StreetNameBrowseGrid_H

/////////////////////////////////////////////////////////////////////////////
// CStreetNameBrowseGrid window.  Grid subclass that uses a FileFollower to browse
// the contents of a file that is being written.
/////////////////////////////////////////////////////////////////////////////

class CStreetNameBrowseGrid : public CGXGridWnd
{
public:
	/////////////////////////////////////////////////////////////////////////////
	// constructor
	/////////////////////////////////////////////////////////////////////////////
	CStreetNameBrowseGrid();

	/////////////////////////////////////////////////////////////////////////////
	// destructor
	/////////////////////////////////////////////////////////////////////////////
	virtual ~CStreetNameBrowseGrid();
	...
	//{{AFX_VIRTUAL(CStreetNameBrowseGrid)
	//}}AFX_VIRTUAL

	///////////////////////////////////////////////////////////////////////////
	// Set the highlighted selection
	///////////////////////////////////////////////////////////////////////////
	void SetRowSelection(int selStart_, int selEnd_);

protected:
	// Generated message map functions
	//{{AFX_MSG(CStreetNameBrowseGrid)
	//}}AFX_MSG
	DECLARE_MESSAGE_MAP()
...
private:
	...
	enum {
		CityStatePostcodeIDColumn = 1,
		PrefixColumn,
		PredirColumn,
		StreetNameColumn,
		SuffixColumn,
		PostdirColumn,
		StreetSegmentIDFirstColumn,
		StreetSegmentCountColumn,
		ColumnCount = StreetSegmentCountColumn
	};
};
