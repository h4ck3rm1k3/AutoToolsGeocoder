...
// StreetSegmentBrowseGrid.h: A "virtual" grid that supports direct browsing of
// the StreetSegment records of the geocoder database.

#ifndef INCL_StreetSegmentBrowseGrid_H
#define INCL_StreetSegmentBrowseGrid_H

/////////////////////////////////////////////////////////////////////////////
// CStreetSegmentBrowseGrid window.  Grid subclass that uses a FileFollower to browse
// the contents of a file that is being written.
/////////////////////////////////////////////////////////////////////////////

class CStreetSegmentBrowseGrid : public CGXGridWnd
{
public:
	/////////////////////////////////////////////////////////////////////////////
	// constructor
	/////////////////////////////////////////////////////////////////////////////
	CStreetSegmentBrowseGrid();

	/////////////////////////////////////////////////////////////////////////////
	// destructor
	/////////////////////////////////////////////////////////////////////////////
	virtual ~CStreetSegmentBrowseGrid();
	...
	//{{AFX_VIRTUAL(CStreetSegmentBrowseGrid)
	//}}AFX_VIRTUAL
...
protected:
	...
	//{{AFX_MSG(CStreetSegmentBrowseGrid)
	//}}AFX_MSG
	DECLARE_MESSAGE_MAP()
...
private:
	...
	enum {
		...
		SegmentIDColumn,
		SegmentCountColumn,
		ColumnCount = SegmentCountColumn
	};
};
