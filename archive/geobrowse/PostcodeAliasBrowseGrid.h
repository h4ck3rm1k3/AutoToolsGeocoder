...
// PostcodeAliasBrowseGrid.h: A "virtual" grid that supports direct browsing of
// the PostcodeAlias records of the geocoder database.

#ifndef INCL_PostcodeAliasBrowseGrid_H
#define INCL_PostcodeAliasBrowseGrid_H

/////////////////////////////////////////////////////////////////////////////
// CPostcodeAliasBrowseGrid window.  Grid subclass that uses a FileFollower to browse
// the contents of a file that is being written.
/////////////////////////////////////////////////////////////////////////////

class CPostcodeAliasBrowseGrid : public CGXGridWnd
{
public:
	/////////////////////////////////////////////////////////////////////////////
	// constructor
	/////////////////////////////////////////////////////////////////////////////
	CPostcodeAliasBrowseGrid();

	/////////////////////////////////////////////////////////////////////////////
	// destructor
	/////////////////////////////////////////////////////////////////////////////
	virtual ~CPostcodeAliasBrowseGrid();
	...
	//{{AFX_VIRTUAL(CPostcodeAliasBrowseGrid)
	//}}AFX_VIRTUAL

protected:
	// Generated message map functions
	//{{AFX_MSG(CPostcodeAliasBrowseGrid)
	//}}AFX_MSG
	DECLARE_MESSAGE_MAP()
