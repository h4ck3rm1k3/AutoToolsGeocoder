...
// StreetNameSoundexBrowseGrid.h: A "virtual" grid that supports direct browsing of
// the StreetNameSoundex records of the geocoder database.

#ifndef INCL_StreetNameSoundexBrowseGrid_H
#define INCL_StreetNameSoundexBrowseGrid_H

/////////////////////////////////////////////////////////////////////////////
// CStreetNameSoundexBrowseGrid window.  Grid subclass that uses a FileFollower to browse
// the contents of a file that is being written.
/////////////////////////////////////////////////////////////////////////////

class CStreetNameSoundexBrowseGrid : public CGXGridWnd
{
public:
	/////////////////////////////////////////////////////////////////////////////
	// constructor
	/////////////////////////////////////////////////////////////////////////////
	CStreetNameSoundexBrowseGrid();

	/////////////////////////////////////////////////////////////////////////////
	// destructor
	/////////////////////////////////////////////////////////////////////////////
	virtual ~CStreetNameSoundexBrowseGrid();
	...
	//{{AFX_VIRTUAL(CStreetNameSoundexBrowseGrid)
	//}}AFX_VIRTUAL
...
protected:
	...
	//{{AFX_MSG(CStreetNameSoundexBrowseGrid)
	//}}AFX_MSG
	DECLARE_MESSAGE_MAP()
