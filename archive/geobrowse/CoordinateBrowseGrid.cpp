...
/////////////////////////////////////////////////////////////////////////////
// CoordinateBrowseGrid.cpp: Display records from a RefQueryFile object.
/////////////////////////////////////////////////////////////////////////////
...
// constructor
/////////////////////////////////////////////////////////////////////////////
CCoordinateBrowseGrid::CCoordinateBrowseGrid() :
	selStart(0), selEnd(-1)
{
}
...
/////////////////////////////////////////////////////////////////////////////
BEGIN_MESSAGE_MAP(CCoordinateBrowseGrid, CGXGridWnd)
	//{{AFX_MSG_MAP(CCoordinateBrowseGrid)
	ON_WM_TIMER()
	ON_WM_DESTROY()
	ON_WM_SIZE()
	//}}AFX_MSG_MAP
...
///////////////////////////////////////////////////////////////////////////
void CCoordinateBrowseGrid::Initialize(
...
///////////////////////////////////////////////////////////////////////////
BOOL CCoordinateBrowseGrid::GetStyleRowCol(
	ROWCOL nRow, 
	ROWCOL nCol, 
	CGXStyle& style, 
	GXModifyType mt, 
	...
	if (mt == gxRemove) {
		...
		const char* label = "";
		switch (nCol) {
		case 1: label = "Latitude"; break;
		case 2: label = "Longitude"; break;
		}
		style.
			SetValue(label).
			SetReadOnly(TRUE);
	...
	if (!refQueryFile->GetCoordinateByIDCached(recordID, coordinate)) {
		style.
			SetValue("***ERROR***");
		return TRUE;
	}
	...
	switch (nCol) {
	case 1: 
		sprintf(buf, "%10.5f", coordinate.latitude);
		style.SetValue(buf);
		break;
	case 2: 
		sprintf(buf, "%10.5f", coordinate.longitude);
		style.SetValue(buf);
		break;
	default:
		style.
...
///////////////////////////////////////////////////////////////////////////
ROWCOL CCoordinateBrowseGrid::GetRowCount()
{
	if (refQueryFile == 0) {
		return 0;
	} else {
		return refQueryFile->GetCoordinateCount();
	}
}
...
///////////////////////////////////////////////////////////////////////////
void CCoordinateBrowseGrid::SetRowSelection(int selStart_, int selEnd_)
{
